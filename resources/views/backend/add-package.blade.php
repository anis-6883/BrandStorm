    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('package.create') }}">Add Package</a></li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="basic-form">
                            <form action="{{ route('package.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <textarea name="package_summary" id="richTextEditor1">{{ old('package_summary') }}</textarea>
                                    </div>

                                    <label class="col-sm-2 col-form-label">Package Description</label>
                                    <div class="col-sm-10 mb-4">
                                        <textarea name="package_description" id="richTextEditor2">{{ old('package_description') }}</textarea>
                                    </div>

                                    <label class="col-sm-2 col-form-label">Package Cost</label>
                                    <div class="col-sm-10 mb-4">
                                        <input type="number" name="package_cost" class="form-control input-default" required autocomplete="off" value="{{ old('package_regular_price') }}">
                                    </div>
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <input type="number" name="package_discount_pct" class="form-control input-default" autocomplete="off" value="{{ old('package_discounted_price') }}">
                                    </div>
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <input type="number" name="duration_hour" class="form-control input-default" autocomplete="off" value="{{ old('duration_hour') }}">
                                    </div>

                                    <label class="col-sm-2 col-form-label">Reach Head</label>
                                    <div class="col-sm-10 mb-4">
                                        <input type="number" name="reach_head" class="form-control input-default" autocomplete="off" value="{{ old('reach_head') }}">
                                    </div>
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <input type="text" name="print_ad_size" class="form-control" value="{{ old('print_ad_size') }}">
                                        <div class="invalid-feedback">
                                            @error('print_ad_size')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <input type="text" name="billboard_location" class="form-control" value="{{ old('billboard_location') }}">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <input type="text" name="video_length" class="form-control" value="{{ old('video_length') }}">
                                        <div class="invalid-feedback">
                                            @error('video_length')
                                                {{ $message }}
                                            @enderror
