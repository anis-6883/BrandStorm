    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/backend/images/users/8.jpg') }}" class="rounded-circle" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/backend/images/users/5.jpg') }}" class="rounded-circle" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/backend/images/users/7.jpg') }}" class="rounded-circle" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/backend/images/users/1.jpg') }}" class="rounded-circle" alt="">
                        ...
                        <div class="table-responsive">
                            <table class="table table-xs mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('assets/backend/images/avatar/5.jpg') }}" class=" rounded-circle mr-3" alt="">Elizabeth W.</td>
                                        <td>Notebook Asus</td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="activity">
                        ...
                        <div class="media border-bottom-1 pt-3 pb-3">
                            <img width="35" src="{{ asset('assets/backend/images/avatar/6.jpg') }}" class="mr-3 rounded-circle">
                            <div class="media-body">
